...
public enum DynamicStatesDYNAMICMESSAGEFlow implements StatesDictAdapter{
	...
	DynamicStatesDYNAMICMESSAGEFlow(String _id,String _name,String _description,boolean _initial,boolean _end){
		this.id=_id;
		this.name=_name;
