...
public enum CAStatesEVENTGROUPFlow implements StatesDictAdapter{
	...
	CAStatesEVENTGROUPFlow(String _id,String _name,String _description,boolean _initial,boolean _end){
		this.id=_id;
		this.name=_name;
