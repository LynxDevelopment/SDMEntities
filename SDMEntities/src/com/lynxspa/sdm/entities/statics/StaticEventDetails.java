...
@Entity
@Table(name="TB_SDM_SECEVENT_DETAILS") 
public class StaticEventDetails {

	public StaticEventDetails() {
	...
	@Id
	@SequenceGenerator(name="SECEVENTDETAIL_GEN", sequenceName="SECEVENTDETAIL_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="SECEVENTDETAIL_GEN")
