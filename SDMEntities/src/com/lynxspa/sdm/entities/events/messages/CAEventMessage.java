...
@Entity
@Table(name="TB_CA_EVENTMESSAGES")
@org.hibernate.annotations.Table(appliesTo="TB_CA_EVENTMESSAGES",indexes={
		@Index(name="IDX_EVMESSAGE_FKEVENT",columnNames="FKEVENT"),
		@Index(name="IDX_EVMESSAGE_FKFORMAT",columnNames="FKFORMAT"),
		@Index(name="IDX_EVMESSAGE_FKEVENTTYPE",columnNames="FKEVENTTYPE"),
		@Index(name="IDX_EVMESSAGE_FKSECURITY",columnNames="FKSECURITY"),
		@Index(name="IDX_EVMESSAGE_DELETED",columnNames="ISDELETED"),
		@Index(name="IDX_EVMESSAGE_CRTDATE",columnNames="CRTDATE"),
		@Index(name="IDX_EVMESSAGE_EFFECTIVEDATE",columnNames="EFFECTIVEDATE"),
		@Index(name="IDX_EVMESSAGE_MESSAGEID",columnNames="MESSAGEID"),
		@Index(name="IDX_EVMESSAGE_ISEXTENSION",columnNames="ISEXTENSION"),
		@Index(name="IDX_EVMESSAGE_EXTENSIONREF",columnNames="EXTENSIONREF"),
		@Index(name="IDX_EVMESSAGE_OPERATIONNORM",columnNames="OPERATIONNORM"),
		@Index(name="IDX_EVMESSAGE_PROVIDER",columnNames="FKPROVIDER"),
		@Index(name="IDX_EVMESSAGE_STATUS",columnNames={"ISENDED","FKSTATE"}),
		@Index(name="IDX_EVMESSAGE_SENDTIMESTAMP",columnNames="SENDERTIMESTAMP"),
		@Index(name="IDX_EVMESSAGE_ISINPORTFOLIO",columnNames="ISINPORTFOLIO")
})
public class CAEventMessage implements UpdatableAdapter,OperableAdapter, CAEventMessageAdapter{
	...
	private Map<String,? extends CAEventMessageFieldAdapter> fields=new HashMap<String,CAEventMessageField>();
	
	
	public CAEventMessage(){
		this(null);
	}
	public CAEventMessage(String _user){
		super();
	...
	@Id
	@SequenceGenerator(name="CAEVENTMESS_GEN", sequenceName="CAEVENTMESS_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="CAEVENTMESS_GEN")
	...
	@ForeignKey(name="FK_EVENTMESSAGE_TYPE")
	@JoinColumns({
	...
	@ForeignKey(name="FK_EVENTMESSAGE_EVENTTYPE")
	...
	@ForeignKey(name="FK_EVENTMESSAGE_SECURITY")
	...
	@ForeignKey(name="FK_EVENTMESSAGE_PROVIDER")
	...
	@OneToMany(targetEntity = CAEventMessageField.class, mappedBy="message",fetch=FetchType.LAZY)
	@MapKey(name="path")
	...
	public void addField(CAEventMessageFieldAdapter field) {
		((Map<String,CAEventMessageField>)this.fields).put(field.getPath(),(CAEventMessageField)field);
	}
	@Transient
	@SuppressWarnings("unchecked")
	public void addField(String _path, String _value) {
		CAEventMessageField field=new CAEventMessageField(this.getAuditor().getCreationUser(),this,_path,_value);
		((Map<String,CAEventMessageField>)this.fields).put(field.getPath(),field);
	}
	@Transient
