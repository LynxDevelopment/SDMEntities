...
@Entity
@Table(name="TB_CA_EVENTEXTDETAILS",uniqueConstraints={
	@UniqueConstraint(columnNames={"FKEVENTDETAIL","EXTENSIONNAME","EXTENSIONNUMBER","VERSION"})	
}) 
@org.hibernate.annotations.Table(
	appliesTo="TB_CA_EVENTEXTDETAILS",
	indexes={
		@Index(name="IDX_EVTEXTDETAIL_FKEVENTDETAIL",columnNames="FKEVENTDETAIL"),
		@Index(name="IDX_EVTEXTDETAIL_VERSION",columnNames="VERSION"),
		@Index(name="IDX_EVTEXTDETAIL_REFID",columnNames="REFID"),
		@Index(name="IDX_EVTEXTDETAIL_EXTENSIONID",columnNames={"EXTENSIONNAME","EXTENSIONNUMBER"}),
		@Index(name="IDX_EVTEXTDETAIL_DELETED",columnNames="ISDELETED")
	}
)
public class CAEventDetailExtended implements VersionableAdapter, CAEventDetailExtendedAdapter {
	...
	public CAEventDetailExtended(){
		this(null,null,0);
	}
	public CAEventDetailExtended(String _user,String _extensionName){
		this(_user,_extensionName,0);
	}
	public CAEventDetailExtended(String _user,String _extensionName,int _extensionNumber){
		super();
	...
	@Id
	@SequenceGenerator(name="CAEVDETEXT_GEN", sequenceName="CAEVDETEXT_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="CAEVDETEXT_GEN")
	...
	@ForeignKey(name="FK_EXTENDED_DETAIL")
