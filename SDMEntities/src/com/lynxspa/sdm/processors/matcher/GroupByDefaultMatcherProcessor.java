...
public class GroupByDefaultMatcherProcessor implements MatcherProcessorAdapter {

	public CAEventGroup findGroupMember(Session _session,CAEventCollected _eventCollected) throws com.lynxspa.exception.FPMException{
		...
		if((reply=(CAEventGroup)query.uniqueResult())==null){
			reply=new CAEventGroup("MATCHERPROCESSGROUPBYDEFAULT",_eventCollected);
