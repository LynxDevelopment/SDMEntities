...
@Entity
@Table(name="HS_SDM_ROWS")
@Inheritance(strategy=InheritanceType.SINGLE_TABLE)
@DiscriminatorColumn(name="DISC_TYPE")
@DiscriminatorValue(value="normal")
public class SDMRowHistoric implements UpdatableAdapter{
	...
	private List<SDMValueHistoric> sdmValues=new ArrayList<SDMValueHistoric>();
	private OperationStatus operationStatus=null;
	
	public SDMRowHistoric(){
		super();
		this.auditor=new UpdateAuditor();
	}
	
	public SDMRowHistoric(String _user){
		super();
	...
	@ForeignKey(name="FK_ROW_HISTORIC_JOB")
	...
	public List<SDMValueHistoric> getSdmValues() {
		return sdmValues;
	}
	public void setSdmValues(List<SDMValueHistoric> sdmValues) {
