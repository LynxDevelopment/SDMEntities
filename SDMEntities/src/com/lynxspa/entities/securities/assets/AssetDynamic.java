...
@Entity
@Table(name="TB_SDM_ASSETSDYNAMIC") 
public abstract class AssetDynamic implements VersionableAdapter,OperableAdapter,AssetAdapter {

	private static final long serialVersionUID = 3267113757931567584L;
	private long id=0l;
	...
	public AssetDynamic(String _user){
		super();
	...
	@Id
	@SequenceGenerator(name="SEQ_ASSETDYNAMIC_GEN", sequenceName="SEQ_ASSETDYNAMIC_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="SEQ_ASSETDYNAMIC_GEN")
	...
	@ForeignKey(name="FK_ASSETDYNAMIC_ASSETTYPE")
	@JoinColumn(name="FKASSETTYPE", nullable=false, updatable=false)
	@Index(name="IX_ASSETDYNAMIC_FKASSETTYPE")
