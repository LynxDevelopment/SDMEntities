...
@Entity
@Table(name="TB_SDM_ASSETDYNAMICDETAILS") 
public class AssetDynamicDetails implements VersionableAdapter, AssetDetailAdapter {

	private static final long serialVersionUID = 2562226106423496097L;
	private long id=0l;
	private HashMap<String, Object> dynamicTable=null;
	private int version=0;
	private VersionAuditor auditor=null;
			
	public AssetDynamicDetails(){
		this(null);
	}
	public AssetDynamicDetails(String _user){
		super();
	...
	@Id
	@SequenceGenerator(name="SEQ_ASSETDYNAMICDETAIL_GEN", sequenceName="SEQ_ASSETDYNAMICDETAIL_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="SEQ_ASSETDYNAMICDETAIL_GEN")
