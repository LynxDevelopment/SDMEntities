...
@Entity
@Table(name="TB_SDM_ASSETSTATICDETAILS") 
public class AssetStaticDetails implements VersionableAdapter, AssetDetailAdapter {
	...
	public AssetStaticDetails(){
		this(null);
	}
	public AssetStaticDetails(String _user){
		super();
	...
	@Id
	@SequenceGenerator(name="SEQ_ASSETSTATICDETAIL_GEN", sequenceName="SEQ_ASSETSTATICDETAIL_GEN", initialValue=1, allocationSize=1)
	@GeneratedValue(strategy=GenerationType.AUTO, generator="SEQ_ASSETSTATICDETAIL_GEN")
