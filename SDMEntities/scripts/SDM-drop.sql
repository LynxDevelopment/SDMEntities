    ...
    drop table HS_SDM_ROWS cascade constraints;

    drop table HS_SDM_VALUES cascade constraints;
    ...
    drop table TB_SDM_ENTERPRISE cascade constraints;

    drop table TB_SDM_ERROR_VALUES cascade constraints;

    drop table TB_SDM_FIELDS cascade constraints;

    drop table TB_SDM_JOBS cascade constraints;

    drop table TB_SDM_JOBTYPE cascade constraints;

    drop table TB_SDM_JOBTYPE_FIELDS cascade constraints;

    drop table TB_SDM_MESSAGEFIELDCONFIGS cascade constraints;

    drop table TB_SDM_MESSAGETYPES cascade constraints;

    drop table TB_SDM_NORMALIZATIONS cascade constraints;

    drop table TB_SDM_NORMALIZATION_FILTERS cascade constraints;

    drop table TB_SDM_PROVIDERS cascade constraints;

    drop table TB_SDM_ROWS cascade constraints;

    drop table TB_SDM_SECEVENTS cascade constraints;

    drop table TB_SDM_SECEVENT_DETAILS cascade constraints;

    drop table TB_SDM_STATUS cascade constraints;
    ...
    drop table TB_SDM_VALUES cascade constraints;
    ...
    drop table TB_SP_SECURITY_EQUITY cascade constraints;

    drop table TB_SP_SECURITY_ETF cascade constraints;

    drop table TB_SP_SECURITY_FASSETS cascade constraints;

    drop table TB_SP_SECURITY_FASSETS_DETAILS cascade constraints;

    drop table TB_SP_SECURITY_FIXED cascade constraints;

    drop table TB_SP_SECURITY_FUND cascade constraints;
    ...
    drop sequence CASPSECURITYEQUITY_GEN;

    drop sequence CASPSECURITYETF_GEN;

    drop sequence CASPSECURITYFIXED_GEN;

    drop sequence CASPSECURITYFUND_GEN;

    drop sequence NORMALIZATION_GEN;

    drop sequence NORM_FILTER_GEN;

    drop sequence SDMENTERPRISE_GEN;

    drop sequence SDMERRORVALUE_GEN;

    drop sequence SDMFIELDS_GEN;

    drop sequence SDMJOBS_GEN;

    drop sequence SDMJOBTYPESFIELDS_GEN;

    drop sequence SDMJOBTYPES_GEN;

    drop sequence SDMROW_GEN;

    drop sequence SDMSTATUS_GEN;

    drop sequence SDMVALUES_GEN;

    drop sequence SECEVENTDETAIL_GEN;

    drop sequence SECEVENT_GEN;
