...
public enum SubMenuLOGSDict implements MenuDictAdapter{

	LOGLIST("LOGLIST","/sdm/logs/loglist","logs list","/fpm/sdm/logs/logList.xwb",null,null);
	...
	SubMenuLOGSDict(String _internalCode,String _code,String _name,String _url,String _urlIcon1,String _urlIcon2){
